...
void main() {
  late Widget cryRecordPage;

  setUp(() {
    //Set up the service container
    TestHelper.setUpServiceContainer();
    cryRecordPage = buildTestableMaterialApp(const CryRecordPage());
  });

  group("Cry record page test", () {
    testWidgets(
      'Verify the page title shows correctly',
      (WidgetTester widgetTester) async {
        await widgetTester.pumpWidget(cryRecordPage);
        await widgetTester.pumpAndSettle();
        final appBar = find.text("Cry Records");
